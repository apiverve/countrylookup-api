...
```gradle
dependencies {
    implementation 'com.github.apiverve:countrylookup-api:1.1.13'
}
```
...
```java
import com.apiverve.countrylookup.CountryLookupAPIClient;
import com.apiverve.countrylookup.APIResponse;
import com.apiverve.countrylookup.APIException;

// Initialize the client
CountryLookupAPIClient client = new CountryLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("country", "USA");
    parameters.put("majorcities", true);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/countrylookup](https://docs.apiverve.com/ref/countrylookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/countrylookup](https://docs.apiverve.com/ref/countrylookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/countrylookup-api/issues)
