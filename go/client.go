...
const (
	baseURL        = "https://api.apiverve.com/v1/countrylookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Country Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Country Lookup API client.
...
// Execute makes a request to the Country Lookup API with typed parameters.
//
