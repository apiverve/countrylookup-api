...
namespace APIVerve\Countrylookup;
...
/**
 * Client for the Country Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/countrylookup?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/countrylookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CountrylookupClient] {$message}\n";
        }
    }
}
