...
namespace APIVerve.API.CountryLookup
{
    ...
    /// <summary>
    /// Client for the CountryLookup API
    /// </summary>
    public class CountryLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/countrylookup";
        ...
        {
            { "country", new ValidationRule { Type = "string", Required = true } },
            { "majorcities", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public CountryLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountryLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountryLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CountryLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CountryLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(CountryLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CountryLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CountryLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CountryLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CountryLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CountryLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CountryLookupQueryOptions options)
        {
